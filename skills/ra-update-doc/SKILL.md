---
name: ra-update-doc
description: "同步文档与代码变更——更新 README、ADR、API 文档、changelog 和内联文档。在代码变更完成但文档过时时使用，或在 ra-ship 临近且文档需要更新时使用。"
version: "1.0.0"
license: MIT
---
...
digraph reliable_update_doc {
    ...
    start [label="启动 /ra-update-doc", shape=doublecircle];
